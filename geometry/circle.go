...
//
//  c := geometry.C(10.1234, geometry.ZV)
...
//
// c := geometry.C(-10, geometry.ZV)
// c.Norm() // returns geometry.Circle{pixel.Vec{0, 0}, 10}
...
//
// c := geometry.C(pixel.ZV, 10)
// c.Resized(-5) // returns geometry.Circle{pixel.Vec{0, 0}, 5}
// c.Resized(25) // returns geometry.Circle{pixel.Vec{0, 0}, 35}
